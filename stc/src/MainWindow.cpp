...
//     }
// }
static int const OPERATOR_BASE_ID = 0;
static int const CLEAR_ID         = 10;
static int const DEC_POINT_ID     = 11;
static int const DIGIT_BASE_ID    = 100;

MainWindow::MainWindow ()
    : QWidget(0) // QMainWindow(0)
